...
catalogList.innerHTML = arrStoreCatalog.map(products => `<div class="p-3" > <div class="card text-center align-items-center ">
                                                        <img c src="${products.image}" class="card-img-top" alt="...">
                                                        <div class="card-body">
