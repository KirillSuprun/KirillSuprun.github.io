...
let arrCountriesCur = countries.map(j => ({
    ...
    cur(obj) {
        // this.currencies = '';
        for(let i in obj){
            this[i].currencies = Object.keys(arrCountriesCur[j].currencies).join('');
            console.log(`arrCountriesCur`, arrCountriesCur);
        }
    }
...
arrCountriesCur = cur(arrCountriesCur);
